...
public class RegistrarUsuario extends javax.swing.JFrame {
    ...
    private void botonContinuarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonContinuarActionPerformed
        if(CUsuario.validarDatosUsuario(campoNombre,campoCedula,campoNombreUsuario,campoClave,campoConfirmacionClave)!=""){
            ...
            Odontologo odontologo = new Odontologo(campoNombre.getText(), CUsuario.convertirAEntero(campoCedula.getText()), campoNombreUsuario.getText(), campoClave.getText());
            if(CUsuario.existe(Datos.getListaOdontologos(), odontologo)){
